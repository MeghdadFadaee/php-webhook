...
class Arr
{
     ...
     */
    public static function exists(ArrayAccess|array $array, float|int|string|null $key): bool
    {
     ...
     */
    public static function first(iterable $array, ?callable $callback = null, mixed $default = null)
    {
        if (is_null($callback)) {
            if (empty($array)) {
            ...
            if (is_array($array) and function_exists('array_first')) {
     ...
     */
    public static function last(iterable $array, ?callable $callback = null, mixed $default = null)
    {
        if (is_null($callback)) {
            if (empty($array)) {
                return value($default);
     ...
     * @return array
     */
    public static function pluck(iterable $array, int|array|string|Closure|null $value, array|Closure|string|null $key = null): array
    {
        $results = [];
     ...
     */
    protected static function explodePluckParameters(array|string|Closure $value, array|Closure|string|null $key): array
    {
